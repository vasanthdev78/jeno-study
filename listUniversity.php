  ...
  <div class="row">
    <div class="col-md-3">
      ...
      <a href="university.php">
        <img src="assets/university/u1.png" class="card-img-top card-img" alt="Card Image">
        <div class="card-body">
          <h5 class="card-title">UNIVERSITY OF MADRAS</h5>
          <p class="card-text">University of Madras · Entrance Examination for the Admission of M.A Economic For the Academic year 2024-2025 .</p>
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card mb-4">
      <a href="university.php">
        <img src="assets/university/u4.png" class="card-img-top card-img" alt="Card Image">
        <div class="card-body">
          <h5 class="card-title">ALAGAPPA UNIVERSITY</h5>
          <p class="card-text">State University | A+ Grade by NAAC (CGPA : 3.64) in the 3rd Cycle | Category - I University by MHRD - UGC
          Karaikudi - 630 003, Tamil Nadu, India.</p>
          </a>
        </div>
      </div>
    </div>
