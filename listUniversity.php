...
<body>
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="card mb-4">
        <img src="https://via.placeholder.com/330x180" class="card-img-top card-img" alt="Card Image">
        <div class="card-body">
          <h5 class="card-title">Card 1</h5>
          <p class="card-text">This is a sample card with some sample text.</p>
    ...
    <div class="col-md-3">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Another card with some more sample text.</p>
          <a href="#" class="btn btn-primary">Read More</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Third card with additional sample text.</p>
          <a href="#" class="btn btn-primary">Read More</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Last card with some more sample text here.</p>
          <a href="#" class="btn btn-primary">Read More</a>
        </div>
      </div>
    </div>
