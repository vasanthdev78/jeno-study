            ...
            <div class="modal-content">
                <form name="frmAddExpense" id="addExpense" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="staticBackdropLabel">Add Income</h4>
                    ...
                    <div class="modal-body p-3">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="course" class="form-label"><b>Income</b></label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" pattern="^\S.*$" title="Please enter a value with no leading or trailing spaces" placeholder="Enter Expense Amount" name="course" id="course" required="required">
                                </div>
                            </div>
                            <div class="col-sm-12">
                        ...
                        <div class="col-sm-12" id="onlinePaymentDetails" style="display:none;">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="course" class="form-label"><b>In.Date</b></label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form name="frmEditExpense" id="editExpense">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="staticBackdropLabel">Edit Income</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-3">
                        <div class="row">
