...
$response = ['success' => false, 'message' => ''];
    ...
    if ($result) {
        ...
        $student = $row['stu_id'];
        $payId_sql ="SELECT `book_id` FROM `jeno_book` WHERE book_stu_id = $student";
    ...
    exit(); 
     ...
     if (isset($_POST['year']) && $_POST['year'] != '') {
        ...
        ,d.add_language
         FROM `jeno_student` AS a
          LEFT JOIN jeno_subject AS b
           ON a.stu_cou_id = b.sub_cou_id 
           LEFT JOIN jeno_course AS c
            ON a.stu_cou_id = c.cou_id 
            LEFT JOIN jeno_stu_additional AS d
             ON a.stu_id = d.add_stu_id 
