                        ...
                        <div class="card bg-transparent mb-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4">You are now successfully log out.</p>
                                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <center>
                        <p>&copy; Kalanthai. All Rights Reserved. <br />Designed and Developed by <a href="#">Roriri Software Solutions Pvt Ltd</a>.</p>
                        </center>
                    </div>
                </div>
            </div>
